...
export class BurgerBuilder extends Component {
  ...
  purchaseButtonState = () => {
    this.setState({ purchasButton: true });
  };
  puhaseContinue = () => { 
    alert('You continue')
  }
  purchaseCancelHand = () => { 
    this.setState({purchasButton: false})
  }
  modalBack = () => { 
  ...
  render() {
    ...
    return (
      <Aux>
        <Modal show={this.state.purchasButton} modalClosed={this.modalBack}>
          <OrderSummary ingredients={this.state.ingredients}
          purchaseCanceld={this.purchaseCancelHand} 
          purchaseContinue={this.puhaseContinue}
        ...
        <BuildControls
          ...
          orderControl={this.purchaseButtonState}
          price={this.state.price}
        />
      </Aux>
    );
